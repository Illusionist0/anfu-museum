...
import Gravity from "../vrhall/Gravity.js";
...
export  class VRHall {
  ...
  loadobj(params){
    ...
    loader.load('../assets/test/test.obj', function (materials) {

      materials.position.set(0, 1, 0)
      materials.scale.set(0.1, 0.1, 0.1)

      const  texture = new TextureLoader().load("./assets/test/test.jpg");
     materials.traverse(function(child) {
